<x-base-layout>
    ...
    <div class="container mt-5">
        ...
        <div class="chat-container shadow-lg">
            ...
            <form action="{{ route('userdashboard.storeChat', $ticket->id) }}" method="POST" class="mt-4">
                ...
                <div class="d-flex gap-2 mt-3 align-items-center">
                    ...
                    <div class="d-flex gap-2" style="flex: 1;">
                        <select name="status_id" id="status_id" class="form-select form-select-sm" style="background-color: #0f172a; border: 1px solid #334155; color: #f8fafc; flex: 1;">
                    ...
                    <div class="d-flex gap-2" style="flex: 1;">
                        <select name="priority_id" id="priority_id" class="form-select form-select-sm" style="background-color: #0f172a; border: 1px solid #334155; color: #f8fafc; flex: 1;">
            ...
            <form id="statusForm" action="{{ route('userdashboard.updateStatus', $ticket->id) }}" method="POST" style="display: none;">
                @csrf
                <input type="hidden" name="status_id" id="statusValue">
            </form>

            <form id="priorityForm" action="{{ route('userdashboard.updatePriority', $ticket->id) }}" method="POST" style="display: none;">
                @csrf
